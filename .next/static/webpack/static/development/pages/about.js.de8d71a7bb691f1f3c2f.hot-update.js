  ...
  _createClass(_default, [{
    ...
    value: function render() {
      if (this.props.query.weather == 'undefined') {
        var _CurrentTempAndLoc = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h1", null, "Ooops!");

        var _DailyTemp = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, "No Valid City Found, Try Again!");
      } else {
        var weatherForecast = this.props.query.weather.forecast;

        var _CurrentTempAndLoc2 = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h1", null, "Weather for ", this.props.query.weather.location.name), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h4", null, "Currently ", this.props.query.weather.current.temperature, " C and ", this.props.query.weather.current.skytext));

        var _DailyTemp2 = weatherForecast.map(function (rows) {
          console.log(rows);
...
//# sourceMappingURL=about.js.de8d71a7bb691f1f3c2f.hot-update.js.map